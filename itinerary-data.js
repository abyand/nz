...
const ITINERARY = {
  ...
  stats: [
    ...
    { value: "4",  label: "Bases" },
    { value: `<svg viewBox="0 0 300 105" width="80" height="28" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:0 auto 3px"><circle cx="75" cy="88" r="16" fill="#2d3a22"/><circle cx="75" cy="88" r="9" fill="#8b7355"/><circle cx="75" cy="88" r="3.5" fill="#2d3a22"/><circle cx="225" cy="88" r="16" fill="#2d3a22"/><circle cx="225" cy="88" r="9" fill="#8b7355"/><circle cx="225" cy="88" r="3.5" fill="#2d3a22"/><path d="M 18 88 L 18 77 Q 20 69 30 66 L 52 62 L 62 46 Q 70 35 84 34 L 180 34 Q 196 34 210 44 L 236 60 L 260 65 Q 274 67 282 76 L 282 82 L 282 88 L 241 88 A 16 16 0 0 0 209 88 L 91 88 A 16 16 0 0 0 59 88 Z" fill="#7a8c6e"/><path d="M 63 53 L 67 45 Q 73 35 86 34 L 180 34 Q 194 34 207 44 L 232 53 Z" fill="#2d3a22"/><path d="M 65 51 L 69 44 Q 75 37 87 36 L 106 36 L 106 51 Z" fill="#e8f0e3" opacity="0.88"/><rect x="110" y="36" width="58" height="16" rx="1.5" fill="#e8f0e3" opacity="0.88"/><path d="M 172 36 L 205 36 Q 218 38 228 50 L 228 51 L 172 51 Z" fill="#e8f0e3" opacity="0.88"/><rect x="86" y="30" width="96" height="5" rx="2" fill="#8b7355"/></svg>`, label: "By Car" }
  ],
